        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <button
                ...
                className="mt-2 w-full flex items-center justify-center gap-2 text-sm bg-accent hover:bg-indigo-500 text-white font-bold py-2 px-4 rounded-md transition disabled:opacity-50"
            >
                {status === 'validating' ? (
                    <>
